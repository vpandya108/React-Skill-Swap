    ...
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-7xl mx-auto flex justify-between items-center p-4">
          ...
          <div className="flex space-x-6 font-medium">
            ...
            <Link to="/MySwap" className="text-gray-700 hover:text-blue-600">My Swaps</Link>
            <Link to="/Messages" className="text-gray-700 hover:text-blue-600">Messages</Link>
          </div>

          {/* RIGHT ICON */}
          <div>
            <Link to="/Accountpage" className="text-gray-700 hover:text-blue-600">
      ...
      <div className="max-w-7xl mx-auto px-6 py-6">
        ...
        <div className="bg-blue-600 text-white rounded-xl p-10 mb-8">
          ...
          <Link to="/explore" className="bg-white text-blue-600 px-6 py-3 rounded-lg font-semibold">
            Start Learning
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="bg-white rounded-xl shadow p-6 mb-6">
              <div className="flex justify-between mb-4">
                ...
                <Link to="/MySwap" className="text-blue-600 text-sm">View All</Link>
              </div>
              ...
              <div className="text-center py-12 text-gray-500">
                ...
                <p className="text-sm mb-4">
                  Start browsing categories to find your first match.
                </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {[
                ...
                },
                {
                  ...
                  img: "https://images.unsplash.com/photo-1492724441997-5dc865305da7?w=400",
                  user: "Marc T."
                }
              ].map((card, index) => (
                <div
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-xl shadow">
              ...
              <Link
                to="/add-skill"
                className="border border-dashed w-full py-2 rounded text-gray-500 block text-center"
              >
                + Add New Skill
              </Link>
            </div>
